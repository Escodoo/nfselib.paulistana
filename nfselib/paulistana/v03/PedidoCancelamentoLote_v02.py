...
#
# Command line:
#   /home/cristiano/nfse_paulistana/venv/bin/generateDS --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "nfselib/paulistana/v03/PedidoCancelamentoLote_v02.py" schemas/nfse/PedidoCancelamentoLote_v02.xsd
#
